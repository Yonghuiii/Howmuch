...
public class Cost extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("LogTest_Cost","            onCreate()"); // 25번 흐름
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       final View view = inflater.inflate(R.layout.fragment_cost,null);

        Button btnSearchAgain = (Button)view.findViewById(R.id.btnSearchAgain);

        Button btngotoMap = (Button)view.findViewById(R.id.btngotoMap);

        Log.i("LogTest_Cost","            onCreateView()"); // 26번 흐름
        ...
        btnSearchAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("LogTest_Cost","              onCreateView 내 버튼 클릭 후 흐름 "); // 26번 흐름
    ...
    public void fragStart_Cost(){
        Fragment frag = new Cost();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.i("LogTest_Cost","             onActivityCreated()");
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        Log.i("LogTest_Cost","            onSaveInstanceState()");
    ...
    public void onDestroyView() {
        ...
        Log.i("LogTest_Cost","               onDestroyView()");
