...
public class MyReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("LogTest_MyReview","                 onCreate()");
    ...
    protected void onStop() { //9번 흐름 - 17번 흐름 - 21번 흐름(새로운 액티비티로 들어가고난 후 얼마이후 진행됨, 이전 액티비티는 멈췄다가 스톱됨) - 28 - 34 - 40 -47 - 53(53-58 : 액티비티 - 프레그먼트로 이동시) -58 - 60
        super.onStop();
        Log.i("LogTest_MyReview","                 onStop()");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("LogTest_MyReview","                 onDestroy()");

     //   finish();

        //Toast.makeText (this, "내 후기.",Toast.LENGTH_SHORT).show();
