...
public class InterestItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interest_item);
        ...
        Log.i("LogTest_Inte_Item","onCreate()");
    ...
    protected void onStop() { //9번 흐름 - 17번 흐름 - 21번 흐름(새로운 액티비티로 들어가고난 후 얼마이후 진행됨, 이전 액티비티는 멈췄다가 스톱됨) - 28 - 34 - 40 -47 - 53(53-58 : 액티비티 - 프레그먼트로 이동시) -58 - 60
        super.onStop();
        Log.i("LogTest_Inte_Item","                 onStop()");
    }
    ...
    protected void onDestroy() {
      ...
      //  finish();
       ...
       // Toast.makeText (this, "관심 항목.",Toast.LENGTH_SHORT).show();
